...
function ProjectPage() {
    ...
    const projectBlocks = projects.map((p, i) => {
        return (
            <div key={i} className="m-4 rounded border border-gray-500 h-min">
                ...
                <section id="cardBody" className="p-2">
                    ...
                    <div className="flex justify-between">
                        <a className="px-2 m-2 border border-gray-500 rounded hover:bg-gray-900" href={p.repo_link}>
                            Code
                        </a>
                        <a className="px-2 m-2 border border-gray-500 rounded hover:bg-gray-900" href={p.web_link}>
                            Demo
                        </a>
                    </div>
                </section>
